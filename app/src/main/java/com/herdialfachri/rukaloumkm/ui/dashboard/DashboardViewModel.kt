...
class DashboardViewModel : ViewModel() {
    ...
    private val _foodItems = MutableLiveData<List<FoodItem>>().apply {
        value = listOf(
            FoodItem(
                R.drawable.seblak, "Seblak Bandung", "Seblak description",
            ...
            FoodItem(
                R.drawable.nyemek, "Mie Nyemek", "Mie Nyemek description",
                "30 Menit", "9 dari 10",
            ...
            FoodItem(
                R.drawable.tahuwalik, "Tahu Walik", "Tahu Walik description",
                "60 Menit", "8 dari 10",
            ...
            FoodItem(
                R.drawable.roti, "Roti Sandwich", "Roti Sandwich description",
            ...
            FoodItem(
                R.drawable.cookies, "Cookies", "Cookies description",
                "80 Menit", "9 dari 10",
            ...
            FoodItem(
                R.drawable.ciskek, "Cheese Cake", "Cheese Cake description",
                "90 Menit", "10 dari 10",
            ...
            FoodItem(
                R.drawable.saladsayur, "Risoles", "Risoles description",
                "45 Menit", "8 dari 10",
